document.addEventListener('DOMContentLoaded', function() {
    ...
    function validatePassword(password) {
        ...
        document.getElementById('reqUppercase').textContent = (hasUppercase ? '✓' : '✗') + ' Al menos una mayúscula';

        document.getElementById('reqLowercase').className = hasLowercase ? 'text-success' : 'text-danger';
        document.getElementById('reqLowercase').textContent = (hasLowercase ? '✓' : '✗') + ' Al menos una minúscula';
